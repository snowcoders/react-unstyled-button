...
describe("UnstyledButton", () => {
    ...
    describe("Classname", () => {
        it("Default has classname", () => {
            ...
            expect(htmlButton.props().className).toContain('sci-react-unstyled-button');
        });
        ...
        it("Disable style has no classname", () => {
            ...
            let htmlButton = wrapper.find('button');
            expect(htmlButton).toHaveLength(1);
            expect(htmlButton.props().className).not.toContain('sci-react-unstyled-button');
        });
    ...
    it("InnerRef", (done => {
        let innerRefHandler: IUnstyledButtonProps["innerRefHandler"] = (ref) => {
